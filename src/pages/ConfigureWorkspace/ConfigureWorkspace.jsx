...
function ConfigureWorkspace({
  ...
  const columns = [
    ...
    },
    {
      field: "type",
      headerName: doI18n(
        "pages:core-local-workspace:row_type",
        i18nRef.current,
      ),
      // minWidth: 80,
      flex: 0.4,
          ...
          >
            ...
            <Grid2 display="flex" gap={1}>
              ...
              >
                <ToggleButton
                  value="ViewEditorTop"
                  onClick={() => setLayout("ViewEditorTop")}
                ...
                <ToggleButton
                  ...
                  onClick={() => setLayout("ViewEditorBottom")}
                  disabled={selectedResources.size === 0}
                >
                  {selectedResources.size === 0 ? (
                ...
                <ToggleButton
                  ...
                  onClick={() => setLayout("ViewEditorLeftColumn")}
                  disabled={selectedResources.size === 0}
                >
                  {selectedResources.size === 0 ? (
                ...
                <ToggleButton
                  ...
                  onClick={() => setLayout("ViewEditorRightColumn")}
                  disabled={selectedResources.size === 0}
                >
                  {selectedResources.size === 0 ? (
                ...
                <ToggleButton
                  ...
                  onClick={() => setLayout("ViewEditorLeftRow")}
                  disabled={selectedResources.size === 0}
                >
                  {selectedResources.size === 0 ? (
                ...
                <ToggleButton
                  ...
                  onClick={() => setLayout("ViewEditorRightRow")}
                  disabled={selectedResources.size === 0}
                >
                  {selectedResources.size === 0 ? (
              ...
              >
                <Box sx={{ flex: 1, minHeight: 0 }}>
                  <DataGrid
                    ...
                    onRowSelectionModelChange={(nv) =>
                      setSelectedResources(nv.ids)
                    }
                    rows={rows}
                    columns={columns}
                    sx={{
