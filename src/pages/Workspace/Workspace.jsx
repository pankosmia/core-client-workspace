...
const Workspace = ({layout, selectedResources}) => {
    ...
    const [rootPane, tileElements] = layoutJson(resourceDetails, layout, i18nRef, distractionModeCount);
        ...
        return (
            <Stack sx={{marginLeft: "1rem"}}>
                <Chip
                    ...
                    icon={(distractionModeCount % 2) === 0 ? <CenterFocusStrongOutlinedIcon/> :
    ...
    return <>
        <Header
            ...
            >
                    {["scripture", "parascriptural"].includes(Object.values(resourceDetails).filter(r => r.primary)[0].flavor_type)}
                <DistractionToggle
